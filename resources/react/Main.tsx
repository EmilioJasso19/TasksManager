...
function Main () {
    const [projectId, setProjectId] = useState<number | null>(null);  // Inicializar como null en lugar de undefined
    const projectsData: any = document.getElementById('app')?.getAttribute('data-projects');
